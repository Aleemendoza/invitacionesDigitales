...
export const demoGift: GiftSectionConfig = { enabled: true, title: "Regalos", message: "Nada es más importante que compartir este día con vos. Si querés hacernos un regalo, dejamos nuestros datos acá.", type: "bank_transfer", protectedDetails: true, accounts: [{ accountHolderFullName: "Sofía & Mateo Mendoza", accountAlias: "SOFIA.MATEO.BODA", bankName: "Banco Galicia", accountType: "Caja de ahorro en pesos", cbuOrCvu: "1234567890123456789012", currency: "ARS" }], styleVariant: "editorial" };
export const demoSocial: SocialPhotoSectionConfig = { enabled: true, title: "Queremos ver tus fotos", description: "Guardá los recuerdos de esta noche y compartilos con nosotros.", socialType: "instagram_handle", socialValue: "sofiamateo", ctaLabel: "Abrir Instagram", showCopyButton: true };
