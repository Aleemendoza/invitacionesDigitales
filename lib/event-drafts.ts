...
export type PlanFeature = "cover" | "agenda" | "map" | "message" | "dress-code" | "gifts" | "whatsapp-rsvp" | "gallery" | "music" | "general-rsvp" | "custom-rsvp" | "csv-export" | "guest-list" | "individual-links" | "qr-album" | "trivia";
...
export const planDetails: Record<Plan, PlanDefinition> = {
  standard: { name: "Estándar", price: 18000, features: ["cover", "agenda", "map", "message", "dress-code", "gifts", "whatsapp-rsvp"], galleryLimit: 1 },
  premium: { name: "Premium", price: 23000, features: ["cover", "agenda", "map", "message", "dress-code", "gifts", "whatsapp-rsvp", "gallery", "music", "general-rsvp", "custom-rsvp", "csv-export"], galleryLimit: 5 },
  premium_plus: { name: "Premium Plus+", price: 28000, features: ["cover", "agenda", "map", "message", "dress-code", "gifts", "whatsapp-rsvp", "gallery", "music", "general-rsvp", "custom-rsvp", "csv-export", "guest-list", "individual-links", "qr-album", "trivia"], galleryLimit: null },
};
...
export function normalizeWhatsapp(value:string|undefined){const digits=(value??"").replace(/\D/g,"");return digits.length>=10&&digits.length<=15?digits:"";}
