...
const sections:LegalSection[]=[
 {id:"solicitar",title:"Solicitar la baja",content:<><p>Podés pedir la baja del evento o cuenta sin iniciar sesión. Indicá email asociado e ID o URL del evento. No envíes tu contraseña.</p><p><a href={`mailto:hola@papeleta.com.ar?subject=${subject}&body=${body}`}>Enviar solicitud de baja</a></p></>},
