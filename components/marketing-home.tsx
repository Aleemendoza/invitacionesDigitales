...
export function MarketingHome() {
  return <main><SiteHeader/><section className={`${styles.hero} hero`}>
    ...
    <section className="section planSummary"><p className="eyebrow">DOS PLANES, TODO CLARO</p><h2>Empezá desde ${planDetails.standard.price.toLocaleString("es-AR")}</h2><p>Invitación reúne toda la información de tu evento. Invitación + Invitados suma confirmaciones, organización, fotos, música, álbum QR y trivia.</p><Link className="button outline" href="/precios">Comparar planes</Link></section>
