...
export function SiteFooter() {
  return <footer className="siteFooter"><div className="footerTop"><div><Link className="brand" href="/">Papeleta<span>✦</span></Link><p>Tu invitación lista para compartir, hecha por vos.</p></div><div className="footerLinks"><div><b>Descubrí</b><Link href="/plantillas">Plantillas</Link><Link href="/precios">Planes y precios</Link><Link href="/#como-funciona">Cómo funciona</Link><Link href="/partner">Papeleta Partner</Link></div><div><b>Tu evento</b><Link href="/crear">Crear invitación</Link><Link href="/mis-eventos">Mis eventos</Link><Link href="/login">Ingresar</Link></div><div><b>Ayuda y legal</b><a href="mailto:hola@papeleta.app">hola@papeleta.app</a><AnalyticsLink href={whatsappUrl} target="_blank" rel="noreferrer" analytics={{ name: "whatsapp_clicked" }}>WhatsApp</AnalyticsLink><Link href="/privacidad">Privacidad</Link><Link href="/terminos">Términos</Link></div></div></div><div className="footerBottom"><span>© 2026 Papeleta.</span><span>Invitaciones digitales para celebrar.</span></div></footer>;
}
