...
const faqGroups: FaqGroup[] = [
  { title: "Sobre los modelos de invitación", questions: [
    { question: "¿Cuál es la diferencia entre los dos planes?", answer: <><h4>Invitación</h4>{p("Incluye el diseño y toda la información de tu evento: fecha, agenda, ubicación, dress code, regalos, foto principal, mensaje y link para compartir.")}<h4>Invitación + Invitados</h4>{p("Suma confirmaciones dentro de la invitación, preguntas personalizadas, lista de invitados, enlaces individuales, galería, música, álbum colaborativo con QR, trivia y descarga de respuestas.")}</> },
  ...
  { title: "Sobre la confirmación de invitados", questions: [
    ...
    { question: "¿Cómo funcionan las invitaciones individuales?", answer: p("Con Invitación + Invitados, cada persona o grupo recibe un enlace preparado con su nombre y los lugares asignados. Así, la información relevante llega clara desde el primer mensaje.") },
